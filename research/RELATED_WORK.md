...
| Mariño et al. (2021), [“Programmatic Strategies for Real-Time Strategy Games”](https://doi.org/10.1609/aaai.v35i1.16114), AAAI 35(1):381–389 | Synthesizes map-specific $\mu$RTS strategies as programs in a domain-specific language. | Programmatic RTS synthesis and map specialization are prior art; StrongBot uses finite parameter configuration and makes no synthesis claim. |
| Medeiros, Aleixo & Lelis (2022), [“What Can We Learn Even from the Weakest? Learning Sketches for Programmatic Strategies”](https://doi.org/10.1609/aaai.v36i7.20744), AAAI 36(7):7761–7769 | Learns program sketches from behavior to guide synthesis in $\mu$RTS. | Learned synthesis guidance is prior art and distinct from the fixed successive-halving configuration mechanism used here. |
| Aleixo & Lelis (2023), [“Show Me the Way! Bilevel Search for Synthesizing Programmatic Strategies”](https://doi.org/10.1609/aaai.v37i4.25626), AAAI 37(4):4991–4998 | Jointly searches state features and programs to improve the synthesis signal. | Feature--program synthesis is prior art; the present contribution is evaluation design rather than search-space novelty. |
| Moraes et al. (2023), [“Choosing Well Your Opponents: How to Guide the Synthesis of Programmatic Strategies”](https://doi.org/10.24963/ijcai.2023/539), IJCAI, pp. 4847–4854 | Selects a set of reference strategies to guide local search for programmatic strategies and evaluates the method in $\mu$RTS. | Opponent-set search guidance is established. The current study uses one pinned opponent and does not claim opponent-selection or synthesis novelty. |
| Moraes & Lelis (2024), [“Searching for Programmatic Policies in Semantic Spaces”](https://doi.org/10.24963/ijcai.2024/662), IJCAI, pp. 5990–5998 | Uses library-induced semantic-space neighborhoods to make programmatic-policy search more sample-efficient in $\mu$RTS. | Semantic-space synthesis is established and methodologically distinct; this paper's novelty remains the family-disjoint, provenance-bound evaluation workflow. |
