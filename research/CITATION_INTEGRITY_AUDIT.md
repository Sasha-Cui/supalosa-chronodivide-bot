...
- `paper/references.bib` contains exactly 27 entries with distinct keys.
- The shared manuscript sources cite all 27 keys.
...
Twenty entries have registered DOIs. Title and publication year returned by
