...
JavaScript bot API and headless offline matches~\cite{chronodivide2026}. We pin
game API version 0.75.0 and Node.js 20.13.1 for the complete empirical path.
...
links; ambiguity favors keeping maps together. This heuristic reduces obvious
revision leakage but does not prove semantic independence.
...
The 54-family pass population was split before training with a private
HMAC-SHA256 permutation. The selected assignment balanced log area and absolute
