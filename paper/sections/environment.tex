...
Table~\ref{tab:threat-controls} maps the principal evaluation threats to the
controls that determine what evidence is admissible. These biases are not
repaired by simply repeating more games.

\begin{table}[t]
\centering
\caption{Threat-to-control map. Each control changes the admissible evidence
or analysis unit rather than merely increasing the repeat count.}
\label{tab:threat-controls}
\small
\begin{tabular}{@{}p{0.18\linewidth}@{\hspace{0.025\linewidth}}
                    p{0.40\linewidth}@{\hspace{0.025\linewidth}}
                    p{0.32\linewidth}@{}}
\toprule
