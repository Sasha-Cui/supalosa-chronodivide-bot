...
The champion scores 0.581, compared with 0.499 for the equal average of the
...
point differences favor the champion (0.019 to 0.131), while every pairwise
...
\begin{figure}[t]
  \centering
  \input{generated/component_effects_plot}
...
A deterministic analyzer validated and reduced all 1,472 raw completion
...
30.58 combatants and 31.19 total units while holding 1,217.93 fewer credits.
...
19.89 more relative combatants, 15.70 more relative units, and 857.68 fewer
credits overall. These endpoints are consistent with converting banked
