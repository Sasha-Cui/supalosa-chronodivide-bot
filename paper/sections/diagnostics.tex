...
\begin{figure}[t]
  ...
  \caption{Champion-minus-one-group-revert effects. Blue shows ordinary
  family-clustered 95\% intervals; orange shows Bonferroni familywise-95\%
  intervals. Scouting has zero endpoint difference and variance, so no
  artificial interval is drawn.}
  \label{fig:components}
\end{figure}

We formed five policies that each revert one group of champion settings to the
reference: defense-radius growth, emergency defense, forced attack, scouting, or
