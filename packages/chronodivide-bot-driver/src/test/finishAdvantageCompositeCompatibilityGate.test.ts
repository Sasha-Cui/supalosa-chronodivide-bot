...
describe("finish-advantage outcome-free composite compatibility gate", () => {
    it("freezes 72 games over all countries, reciprocal slots, and fresh seeds", () => {
        ...
        expect(FINISH_ADVANTAGE_COMPOSITE_COMPATIBILITY_AMENDMENT_5_SHA256).toHaveLength(64);
        expect(FINISH_ADVANTAGE_COMPOSITE_COMPATIBILITY_AMENDMENT_6_SHA256).toHaveLength(64);
        ...
        expect(FINISH_ADVANTAGE_COMPOSITE_COMPATIBILITY_MAX_TICKS).toBe(24_000);
