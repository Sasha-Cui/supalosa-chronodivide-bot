...
import {
    MISSION_NATIVE_CLOSEOUT_FOCUSED_GATE_V28_COUNTRIES,
    MISSION_NATIVE_CLOSEOUT_FOCUSED_GATE_V28_ENGINE_SEED_BASE,
    validateMissionNativeCloseoutFocusedGateV28Telemetry,
} from "../training/missionNativeCloseoutFocusedGateV28.js";
...
describe("mission-native closeout focused gate v28", () => {
    it("keeps every focused seed inside the engine uint32 domain", () => {
        for (const index of MISSION_NATIVE_CLOSEOUT_FOCUSED_GATE_V28_COUNTRIES.keys()) {
    ...
    it("accepts an objective-feasible direct launch despite zero readiness composition", () => {
        expect(() => validateMissionNativeCloseoutFocusedGateV28Telemetry(
