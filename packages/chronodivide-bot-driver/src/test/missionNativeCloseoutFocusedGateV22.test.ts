...
import { validateMissionNativeCloseoutFocusedGateV22Telemetry } from
    "../training/missionNativeCloseoutFocusedGateV22.js";
...
const valid = (): BuildingEliminationTelemetryEvent[] => [
    {
        ...
        mainTankPresent: true, requested: true,
    },
    {
        schemaVersion: 17, event: "assault_screen_production", tick: 3_730,
...
describe("mission-native closeout focused gate v22", () => {
    it("requires persistent production after a physical tank plus building damage", () => {
        expect(() => validateMissionNativeCloseoutFocusedGateV22Telemetry(valid(), Countries.USA)).not.toThrow();
    });
    ...
    it("fails closed if production telemetry ends on tank acquisition", () => {
        ...
        expect(() => validateMissionNativeCloseoutFocusedGateV22Telemetry(
