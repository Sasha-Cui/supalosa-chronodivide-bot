...
import {
    MISSION_NATIVE_CLOSEOUT_ALL_COUNTRY_GATE_V29_COUNTRIES,
    MISSION_NATIVE_CLOSEOUT_ALL_COUNTRY_GATE_V29_ENGINE_SEED_BASE,
    MissionNativeCloseoutAllCountryV29CoverageRow,
    validateMissionNativeCloseoutAllCountryV29Coverage,
} from "../training/missionNativeCloseoutAllCountryGateV29.js";

const validRows = (): MissionNativeCloseoutAllCountryV29CoverageRow[] =>
    MISSION_NATIVE_CLOSEOUT_ALL_COUNTRY_GATE_V29_COUNTRIES.flatMap((country) =>
...
describe("mission-native closeout all-country gate v29", () => {
    it("freezes all nine countries and both reciprocal slots", () => {
        expect(MISSION_NATIVE_CLOSEOUT_ALL_COUNTRY_GATE_V29_COUNTRIES).toEqual([
            Countries.USA,
            Countries.KOREA,
            Countries.FRANCE,
            Countries.GERMANY,
        ...
        expect(validateMissionNativeCloseoutAllCountryV29Coverage(validRows())).toEqual([]);
    });
    ...
    it("fails closed on a missing reciprocal cell", () => {
        ...
        expect(validateMissionNativeCloseoutAllCountryV29Coverage(rows)).toEqual(expect.arrayContaining([
