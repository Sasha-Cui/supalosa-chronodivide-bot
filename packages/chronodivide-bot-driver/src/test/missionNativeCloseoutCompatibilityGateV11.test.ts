...
import {
    summarizeMissionNativeCloseoutV11,
    validateMissionNativeCloseoutV11Exposure,
} from "../training/missionNativeCloseoutCompatibilityGateV11.js";
...
const validTelemetry = (): BuildingEliminationTelemetryEvent[] => [
    ...
    },
    {
        ...
        tick: 2_700,
        reason: "no_viable_route_clearance",
        ownCombatants: 2,
        enemyCombatants: 8,
...
describe("mission-native closeout compatibility v11", () => {
    it("validates blocker persistence followed by a physical building phase", () => {
        const telemetry = validTelemetry();
        expect(() => validateMissionNativeCloseoutV11Exposure(
            telemetry,
            Countries.USA,
            0,
        )).not.toThrow();
        expect(summarizeMissionNativeCloseoutV11(telemetry)).toMatchObject({
            buildingDamage: 10,
